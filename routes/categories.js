...
//     let catObj = {
//       name: req.body.name,
//       slug: slugify(req.body.name, { lower: true }), // Generate slug only if name exists
//     };

//     // If images are provided, add them to the object
//     if (imagesArr && imagesArr.length > 0) {
//       catObj.images = imagesArr;
//       catObj.color = req.body.color; // Add color if needed
//     }
...
//     // Reset imagesArr after the save operation
//     imagesArr = [];
...
//     // Handle any errors
//     res.status(500).json({
//       error: err.message || 'Error while creating category',
//       success: false,
//     });
//   }
// });
